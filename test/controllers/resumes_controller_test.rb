...
class ResumesControllerTest < ActionController::TestCase
  ...
  test "should create resume" do
    assert_difference('Resume.count') do
      post :create, resume: { description: @resume.description, name: @resume.name, published: @resume.published, user_id: @resume.user_id }
    end
  ...
  test "should update resume" do
    patch :update, id: @resume, resume: { description: @resume.description, name: @resume.name, published: @resume.published, user_id: @resume.user_id }
    assert_redirected_to resume_path(assigns(:resume))
  end
